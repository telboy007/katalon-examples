...
Mobile.tap(findTestObject('Object Repository/Change language - drop down'), 0)

Mobile.tap(findTestObject('Object Repository/Change language - drop down - missing en.Romanian translation'), 0)

Mobile.tap(findTestObject('Object Repository/Change language - SUBMIT'), 0)
