...
if (WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Florence'), 2) == false &&
	
	WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Florence'), 2) == false)
	{
		...
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Florence'),
			3)
		
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Florence'),
			3)
