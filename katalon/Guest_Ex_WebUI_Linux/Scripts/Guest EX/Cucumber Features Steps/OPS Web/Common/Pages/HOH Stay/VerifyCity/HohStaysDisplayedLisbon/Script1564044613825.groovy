...
if (WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Lisbon'), 2) == false &&
	
	WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Lisbon'), 2) == false)
	{
		...
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Lisbon'),
			3)
		
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Lisbon'),
			3)
