...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/Cities Check-ins/Guest_App_CheckinTime_Bangkok'), 3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/Cities Check-ins/Guest_App_CheckOutTime_Bangkok'), 3)
