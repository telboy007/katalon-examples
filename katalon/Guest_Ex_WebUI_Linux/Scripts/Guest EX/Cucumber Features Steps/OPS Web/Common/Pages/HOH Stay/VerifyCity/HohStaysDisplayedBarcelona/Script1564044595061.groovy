...
if (WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Barcelona'), 2) == false &&
	
	WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Barcelona'), 2) == false)
	{
		...
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Barcelona'),
			3)
		
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Barcelona'),
			3)
