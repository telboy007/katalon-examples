...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/button_stay_details'), 6)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/button_Submit check-in information'), 3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/Cities Check-ins/Guest_App_CheckinTime_London'), 3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/Cities Check-ins/Guest_App_CheckOutTime_London'), 3)
