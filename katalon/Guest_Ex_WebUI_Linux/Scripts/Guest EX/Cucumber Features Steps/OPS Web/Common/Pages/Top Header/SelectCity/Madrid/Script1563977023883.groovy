...
if (WebUI.waitForElementClickable(findTestObject('OPS Web/Common/Top Header/menu_item_All'), 3) == true) {
    ...
    if (WebUI.verifyElementVisible(findTestObject('OPS Web/Common/Top Header/menu_item_Madrid')) == true) {
        WebUI.waitForElementClickable(findTestObject('OPS Web/Common/Top Header/menu_item_Madrid'), 3)

        WebUI.click(findTestObject('OPS Web/Common/Top Header/menu_item_Madrid'))
    } else {
