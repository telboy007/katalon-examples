...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/ConfirmedPage/WhatToDo/element_what_to_do_florence'), 
    3)
...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/ConfirmedPage/Page_Hostmaker/EmailAndPhone/text_phone_florence'), 3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/ConfirmedPage/Page_Hostmaker/text_powered by Tiqets'), 
    3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/ConfirmedPage/Page_Hostmaker/EmailAndPhone/text_email_florence'), 
    3)
