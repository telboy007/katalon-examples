...
if (WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Rome'), 2) == false &&
	
	WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Rome'), 2) == false)
	{
		...
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/element_id_Rome'),
			3)
		
		WebUI.waitForElementVisible(findTestObject('OPS Web/Common/HOH Stay/CitiesElements/elemenet_timezone_Rome'),
			3)
	}