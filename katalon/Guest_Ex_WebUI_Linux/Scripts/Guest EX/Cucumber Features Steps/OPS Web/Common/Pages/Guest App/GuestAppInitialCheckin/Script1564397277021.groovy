...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/text_Arrival notes'), 3, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/label_Business  work'), 3)
...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/dropdown_checkin_time'), 3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/dropdown_checkout_time'), 3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/field_extra_keys'), 3)
...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/CheckIn/text_Extra Key'), 3)
