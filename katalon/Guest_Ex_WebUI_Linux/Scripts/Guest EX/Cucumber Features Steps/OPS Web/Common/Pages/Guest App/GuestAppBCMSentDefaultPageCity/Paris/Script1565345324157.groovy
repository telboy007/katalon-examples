...
WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/Cities Check-ins/Guest_App_CheckinTime_Paris'), 3)

WebUI.verifyElementPresent(findTestObject('OPS Web/Common/GuestApp/Cities Check-ins/Guest_App_CheckOutTime_Paris'), 3)
